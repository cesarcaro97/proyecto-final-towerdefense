...
namespace PathFinding
{
    ...
    public class Pathfinding
    {
        ...
        public static List<Point> FindPath(Grid grid, Point startPos, Point targetPos, DistanceType distance = DistanceType.Manhattan, bool ignorePrices = false)
        {
            // find path
        ...
        private static List<Node> _ImpFindPath(Grid grid, Point startPos, Point targetPos, DistanceType distance = DistanceType.Manhattan, bool ignorePrices = false)
        {
